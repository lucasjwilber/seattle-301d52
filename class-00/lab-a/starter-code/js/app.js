...
function displayPics(){
  ...
  //Because const is block scoped and rando was defined in a code block, once that block of code had finished executing
  //rando was removed from memory. So trying to use that variable would no longer work.
  console.log(viewed);
