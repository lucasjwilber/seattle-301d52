...
//it is the parent object (the Student with name: joe)

// 2. What is "this" when joe.scopeArrow() is invoked?
//it is the global Window object

// 3. Explain why "this" is different when an arrow function is used.
//when 'this' is used within arrow functions, 'this' will find the next upper-level object that wasn't instantiated with an arrow function. in this case that was the Window object.
